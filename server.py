...
<div class="container">
    ...
    <div class="card"><h3>📌 О СИСТЕМЕ</h3><p>Система прогнозирования отказов предназначена для автоматического обнаружения аномалий в работе инфокоммуникационных систем и прогнозирования вероятности отказов на основе анализа временных рядов метрик.</p><p style="margin-top:10px;"><span class="badge">Эмуляция</span> Данная версия использует эмуляцию данных на основе физических закономерностей (сезонность, деградация, шум).</p></div>
    ...
    <div class="card"><h3>⚙️ ТЕХНОЛОГИИ</h3><ul><li><strong>Backend:</strong> Python 3.14 + Flask + Gunicorn</li><li><strong>Frontend:</strong> HTML + CSS + JavaScript + Chart.js</li><li><strong>Эмуляция:</strong> Математические модели</li></ul></div>
    <div class="footer">Инфокоммуникационная система | Предиктивная аналитика | © 2026</div>
</div>
<script>
    let darkTheme = true;
